            ...
            try
            {
                ...
                if (storages.Count == 1)
                {
                    ...
                    if (sy_showinfos.Count == 1)
                    {
                        ...
                        result = dataInterface.UploadData(sy_showinfo.OperateType.ToString(), sy_showinfo.OrderMasterID, sy_showinfo.OrderDetailID, sy_showinfo.OperateType.ToString(), sy_showinfo.OperatePiece, sy_showinfo.OperateItem, "");
                    }                   
                    //++
            ...
            try
            {
                ...
                switch (elOpertor.GetShowModeName())
                {
                    case "mode1": //货架汉显示标签 显示模式 <大标签>
                        ...
                        elOpertor.SetFunction(1, 0, 1, 20, 0, 0);
                        elOpertor.Start();
                        Reset();
                        break;
