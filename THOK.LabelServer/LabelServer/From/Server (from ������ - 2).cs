    ...
    public partial class Server : Form
    {
        ...
        private void btStart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                IList<Storages> storages = storagesAccesser.Select<Storages>("select Port from storages group by port order by port");

                if (adapters == null)
                {
                    adapters = new Adapter[100];
        ...
        private void 填入模似数据ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            foreach (Storages storage in storages)
            {
                try
                {
                    sy_showinfosAccesser.ExecuteNonQuery ("insert [Sy_ShowInfo]  values ('0', 'OrderDetailID','" + storage.StorageID.Trim() + "',1,'红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙红金龙',30,12,0,0,0,'')");
                } catch { }
            }
        }
